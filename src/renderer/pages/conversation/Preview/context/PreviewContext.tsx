...
const PREVIEW_TABS_KEY = 'veraui_preview_tabs';
const PREVIEW_ACTIVE_TAB_ID_KEY = 'veraui_preview_active_tab_id';
const LEGACY_PREVIEW_STATE_KEY = 'veraui_preview_state';
