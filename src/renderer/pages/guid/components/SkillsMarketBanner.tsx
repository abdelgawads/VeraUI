...
const SKILLS_MARKET_DETAILS_ZH = 'https://github.com/abdelgawads/VeraUI/discussions';
const SKILLS_MARKET_DETAILS_EN = 'https://github.com/abdelgawads/VeraUI/discussions';
