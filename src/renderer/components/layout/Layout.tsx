...
const Layout: React.FC<{
  ...
  useEffect(() => {
    ...
    const handleCheckUpdate = () => {
      ...
      setTimeout(() => {
        window.dispatchEvent(new CustomEvent('veraui-open-update-modal', { detail: { source: 'tray' } }));
      }, 100);
    };
        ...
        <ArcoLayout className={'size-full layout flex-1 min-h-0'}>
          ...
          >
            ...
            >
              ...
              <div className='flex-1 text-20px text-1 collapsed-hidden font-bold'>VeraUI</div>
              {isMobile && !collapsed && (
                <button
                  type='button'
