export const WORKSPACE_TOGGLE_EVENT = 'veraui-workspace-toggle';
export const WORKSPACE_STATE_EVENT = 'veraui-workspace-state';
export const WORKSPACE_HAS_FILES_EVENT = 'veraui-workspace-has-files';
