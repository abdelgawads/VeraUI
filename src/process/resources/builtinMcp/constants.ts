...
export const BUILTIN_IMAGE_GEN_NAME = 'veraui-image-generation';
export const BUILTIN_IMAGE_GEN_LEGACY_NAMES = ['VeraUI Image Generation', BUILTIN_IMAGE_GEN_ID] as const;
