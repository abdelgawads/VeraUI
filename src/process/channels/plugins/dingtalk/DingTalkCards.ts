...
export function createMainMenuCard(): DingTalkCard {
  return {
    title: 'VeraUI Assistant',
    text: '### VeraUI Assistant\n\nWelcome! Choose an action below:',
    btnOrientation: '1',
    btns: [
...
export function createPairingHelpCard(): DingTalkCard {
  return {
    ...
    text: [
      ...
      '',
      '**What is pairing?**',
      'Pairing links your DingTalk account with the local VeraUI application.',
...
export function createHelpCard(): DingTalkCard {
  return {
    title: 'VeraUI Assistant Help',
    text: [
      '### VeraUI Assistant Help',
      '',
      'A remote assistant to interact with VeraUI via DingTalk.',
      '',
      '**Common Actions:**',
