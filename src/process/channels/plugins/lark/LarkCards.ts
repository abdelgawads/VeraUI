...
export function createMainMenuCard(): LarkCard {
  return {
    ...
    header: {
      title: { tag: 'plain_text', content: 'VeraUI Assistant' },
      template: 'blue',
    },
    elements: [
      {
    ...
    elements: [
      {
        tag: 'markdown',
        content: [
          'Please pair your account with VeraUI:',
          '',
          `**Pairing Code:** \`${pairingCode}\``,
          '',
          '1. Open VeraUI settings',
    ...
    elements: [
      {
        ...
        content: [
          ...
          `**Pairing Code:** \`${pairingCode}\``,
          '',
          'Please approve in VeraUI settings:',
          '1. Open VeraUI app',
...
export function createHelpCard(): LarkCard {
  return {
    config: { wide_screen_mode: true },
    header: {
      title: { tag: 'plain_text', content: '❓ VeraUI Assistant Help' },
      template: 'turquoise',
    },
    elements: [
      {
        tag: 'markdown',
        content: [
          'A remote assistant to interact with VeraUI via Lark.',
          '',
          '**Common Actions:**',
