...
for f in VeraUI-1.0.0-win-x64.exe VeraUI-1.0.0-win-arm64.exe VeraUI-1.0.0-mac-x64.dmg VeraUI-1.0.0-mac-arm64.dmg VeraUI-1.0.0.deb VeraUI-1.0.0-arm64.deb; do
  if [ ! -f "$OUTPUT_DIR/$f" ]; then
