...
preflight:
    ...
    $failed = $false; \
    Write-Host "=========================================="; \
    Write-Host "  VeraUI Build Preflight Check"; \
    Write-Host "=========================================="; \
    Write-Host ""; \
...
info:
    Write-Host "VeraUI Build Environment"; \
    Write-Host "========================"; \
...
build-win: preflight
    ...
    Get-Process -Name "VeraUI","electron" -ErrorAction SilentlyContinue | Stop-Process -Force -ErrorAction SilentlyContinue; \
